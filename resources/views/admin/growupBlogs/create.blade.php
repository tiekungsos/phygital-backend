...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.growupBlog.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.growup-blogs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="blog_name">{{ trans('cruds.growupBlog.fields.blog_name') }}</label>
                <input class="form-control {{ $errors->has('blog_name') ? 'is-invalid' : '' }}" type="text" name="blog_name" id="blog_name" value="{{ old('blog_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_write') ? 'is-invalid' : '' }}" type="text" name="name_write" id="name_write" value="{{ old('name_write', '') }}">
